...
class _$CoursesStateImpl implements _CoursesState {
  ...
  @override
  String toString() {
    return 'CoursesState(vocabularies: $vocabularies, phrases: $phrases, userPreferences: $userPreferences, analytics: $analytics, dataManagement: $dataManagement, courseCompletion: $courseCompletion, isRefreshing: $isRefreshing)';
  }
...
abstract class _CoursesState implements CoursesState {
  const factory _CoursesState(
      ...
      final bool isRefreshing}) = _$CoursesStateImpl;
