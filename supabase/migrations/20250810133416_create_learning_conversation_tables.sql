-- Create learning conversation tables for AI-powered language learning
-- This migration creates tables for storing learning requests, vocabularies, and phrases
