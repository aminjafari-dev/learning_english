...
// Main coordinator local data source for courses feature using composition pattern.
// This class combines specialized data sources for learning requests, conversation threads, and analytics.
// Usage: Use this class as the main entry point for all courses local data operations.
...
/// Main coordinator local data source for courses using composition pattern
/// This class delegates operations to specialized data sources for better maintainability
/// Usage: Use this as the main interface for all courses local data operations
class CoursesLocalDataSource {
  ...
  Future<void> initialize() async {
    try {
      ...
      throw Exception(
        'Failed to initialize courses data sources: ${e.toString()}',
      );
    }
  }
...
// Example usage:
// final localDataSource = CoursesLocalDataSource();
