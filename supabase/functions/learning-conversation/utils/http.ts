...
import type { LearningConversationResponse } from '../types.ts';
 ...
 */
export function createSuccessResponse(response: string, requestId?: string): Response {
  const body: LearningConversationResponse = {
    success: true,
    response,
    requestId,
  };
